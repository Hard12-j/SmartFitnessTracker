package com.wellnest.blog.controller;

import com.wellnest.blog.dto.BlogDTO;
import com.wellnest.blog.dto.BlogCommentDTO;
import com.wellnest.blog.service.BlogService;
...
public class BlogController {
    ...
    public ResponseEntity<BlogCommentDTO> updateComment(@PathVariable Long commentId, @RequestBody BlogCommentDTO commentDTO) {
        try {
            BlogCommentDTO updatedComment = blogService.updateComment(commentId, commentDTO);
    ...
    @PostMapping("/{id}/like")
    public ResponseEntity<Map<String, Object>> toggleLike(@PathVariable Long id, @RequestBody Map<String, String> request) {
        try {
